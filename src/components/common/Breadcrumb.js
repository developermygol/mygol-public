  ...
  render() {
    ...
    return (
      <div className="BreadCrumb">
        <div className="TournamentLogo" style={{ backgroundImage: 'url(' + tournamentLogo + ')' }}></div>
        <div className="Tournament">
          <p>
            <Link to="/tournaments" onClick={this.handleClick}>
              <Loc>Tournaments</Loc>
            </Link>
          </p>
          <Link to={'/tournaments/' + pa.idTournament}>
            <h3 className="Color2">{t.name}</h3>
          </Link>
        </div>
        ...
        {team ? (
          <Fragment>
            ...
            <div className="Team">
              <p>
                <Link to={'/tournaments/' + t.id + '/teams'} onClick={this.handleClick}>
                  <Loc>Teams</Loc>
                </Link>
              </p>
              <h3>{team.name}</h3>
