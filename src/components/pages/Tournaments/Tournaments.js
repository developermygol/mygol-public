...
class Tournaments extends Component {
    ...
    getTournamentLogo = (tournament) => {
        return <img alt='' src={getUploadsIcon(tournament.logoImgUrl, tournament.id, 'tournament')} className='Logo'/>
    }
    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                <CrudForm 
                    title={<TitleTwoLinesComponent title={Localize('Select')} title2={Localize('Tournament')} className='Tournament'/>}
