...
class DetailField extends Component {
    render() {
        ...
        return (
            <div className='Field'>
                <p className='Header'><Loc>{p.label}</Loc></p>
            ...
            <div className=''>
                ...
                <div className='Content'>
                    {sanction.type === 2 ? (   // Team sanctions
                        <Fragment>
                            <h3><Loc>Sanctions.Type.Team</Loc></h3>
                            <div className='Details Horizontal'>
                                <DetailField label='Team' value={getTeamLink(sanction.idTournament, sanction.idTeam, sanction.team && sanction.team.name)} />
                            ...
                            <div className='Details Horizontal'>
                                ...
                                <DetailField label='Sanctions.Match' value={getMatchLink(sanction.idTournament, sanction.idMatch, Localize('Sanctions.Match.Click'))} />
                            </div>
                        </Fragment>
                    ) : (
                            <Fragment>
                                <h3><Loc>Sanctions.Type.Player</Loc></h3>
                                <div className='Details Horizontal'>
                                    <DetailField label='Player' value={getPlayerLink(sanction.idTournament, sanction.idTeam, sanction.player)} />
                                    <DetailField label='Team' value={getTeamLink(sanction.idTournament, sanction.idTeam, sanction.team && sanction.team.name)} />
                                    <DetailField label='Tournament' value={getTournamentLink(sanction.idTournament, sanction.tournament && sanction.tournament.name)} />
                                </div>
                                <div className='Details Horizontal'>
                                    <DetailField label='Start date' value={getFormattedDate(sanction.startDate)} />
    ...
    render() {
        ...
        return (
            <div className='Section'>
                ...
                <div className='Content'>
                    {p.allegations && p.allegations.map(al => <SanctionAllegation key={al.id} allegation={al} />)}
                </div>
            </div>
        )
    }
...
class SanctionMatches extends Component {
    render() {
        ...
        return (
            <div className='Section'>
                <h3><Loc>Sanctions.Matches</Loc></h3>
                <div className='MatchesTable'>
                    <table>
                        <tbody>
                            {matches && matches.map(m => {
                                return <MatchView key={m.id} tId={sanction.idTournament} match={m} home={m.homeTeam} visitor={m.visitorTeam} displaySanctioned />
                            })}
                        </tbody>
                    </table>
                </div>
