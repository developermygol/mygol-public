...
class CalendarView extends Component {
    ...
    getStageContent = (stage) => {
        ...
        return (
            <TabControl key={stage.id} defaultTab={tabIndex} items={stageDays} contentCallback={this.getDayContent} />
        )
    }
    ...
    render() {
        ...
        return (
            <TabControl defaultTab={tabIndex} items={days} contentCallback={this.getDayContent} />
        )
    }
}
