        ...
        return (
            <div className={'Team'}>
                <div className='LargeTeamInfo '>
                    ...
                    <Link to={'/tournaments/' + idTournament + '/teams/' + team.id}><p className='TeamName'>{team.name}</p></Link>
                </div>
            </div>
        )
    }
        ...
        return (
            <div className='MatchStatus'>
                ...
                <div className='Scores'>
                    { match.status >= 3 ? 
                        <Fragment>
                            <span className='Score'>{match.homeScore}</span> <span className='Score'>{match.visitorScore}</span>
                        </Fragment>
                        : null
                    }
                </div>
                <div className='Details'>
                    <p><span className={'MatchStatus' + match.status}><Loc>{'MatchStatus' + match.status}</Loc></span></p>
                </div>
            </div>
        )
    }
