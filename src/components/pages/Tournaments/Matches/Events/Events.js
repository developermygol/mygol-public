...
const matchEventTypes = [ 1, 10, 11, 12, 13, 15, 16, 17, 18, 30, 31, 32, 33, 34, 40, 41, 42, 50, 61, 62, 63, 64, 65, 100 ];
            ...
            <div className='MatchEvents'>
                ...
                <CrudForm 
                    ...
                    fieldDefinition={[
                        ...
                        { fieldName: 'type', editRenderType:'radio', localizedLabel: 'MatchEventType', selectOptions: this.getTypeOptions(), passProps: { className:'MatchEventTypeField' }, rules: 'required' },
                        { fieldName: 'idTeam', editRenderType:'radio', localizedLabel: 'MatchEventTeam', selectOptions: this.getTeamOptions(), passProps: { className:'MatchEventTeamField' } },
                        { fieldName: 'idDay', showInList: false, canEdit: false },
                        { fieldName: 'idPlayer', editRenderType:'radio', localizedLabel: 'MatchEventPlayer', selectOptions: this.players, passProps: { className:'MatchEventPlayerField' } },
