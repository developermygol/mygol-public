...
class KnockoutMatch extends Component {
  render() {
    ...
    return (
      <div className="KnockoutMatch Color1">
        <KnockoutTeam
          team={homeTeam}
          description={match.homeTeamDescription}
          score={match.homeScore}
          {...p}
          showScore={match.status >= 3}
        />
        <KnockoutTeam
          team={visitorTeam}
          description={match.visitorTeamDescription}
...
class KnockoutTeam extends Component {
  render() {
    ...
    return (
      <div className="KnockoutTeam Color1">
        {team ? (
          <Fragment>
