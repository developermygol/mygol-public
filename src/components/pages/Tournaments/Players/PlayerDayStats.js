  ...
  render() {
    ...
    return (
      <div className="PlayerDayStats">
        ...
        <p>&nbsp;</p>
        <StatsDetailField caption="Data1" value={palyerDayResults.ranking1} total={0} />
        <StatsDetailField caption="Data2" value={palyerDayResults.ranking2} total={0} />
        <StatsDetailField caption="Data3" value={palyerDayResults.ranking3} total={0} />
        <p>&nbsp;</p>
