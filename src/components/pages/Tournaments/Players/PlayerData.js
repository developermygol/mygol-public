  ...
  return (
    <div className={'PlayerData Section' + (backImg ? ' WithBackground' : '')}>
      <div className="SimpleTeam">
        ...
        <p className="TeamName Color1">{team && team.name}</p>
      </div>
      <table className="DetailsTable">
        <tbody>
          ...
          <tr>
            <td className="Key">
              <Loc>FieldPosition</Loc>
            </td>
            <td>
              <Loc>
                {teamData && teamData.fieldPosition ? 'FieldPosition' + player.teamData.fieldPosition : ''}
              </Loc>
            </td>
          </tr>
          <tr>
            ...
            <td className="Color1">{team.name}</td>
          </tr>
          <tr>
            <td className="Key">
              <Loc>ApparelNumber</Loc>
            </td>
            <td>{player.teamData.apparelNumber}</td>
          </tr>
        </tbody>
      </table>
    </div>
